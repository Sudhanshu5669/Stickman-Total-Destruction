...
| 6 | **Weapon pixel art** — hand-authored sprites for all 19 rounds | **done (awaiting art call)** | PASS 2026-08-22 — all 19 rasterise and draw crisp in-hand at gameplay zoom. Contact sheet at `/gunsheet.html` (dev-only, not in dist). Procedural path kept as fallback. **User to judge whether this clears the professional bar or supplies sprites instead** |
